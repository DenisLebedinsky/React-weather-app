...
//Возвращает компонент прогноза по определенному дню.
export const forcastDay = (date, i) => {
    return <div className="col-lg-2 col-md-2 col-sm-2 col-xs-4 animated fadeInDown group_weather" key={i}>
        <h4>
        ...
        <dl>
            <dd className="weatherstate d-flex justify-content-center">
                <div className={`state-icon-sml state-${date.weather_state_abbr}`}/>
